...
<template>
  <div class="dark:bg-black bg-white sticky top-0 backdrop-blur-lg backdrop-filter bg-opacity-70 dark:bg-opacity-80 z-10">
    <nav class="container px-4 py-5 mx-auto md:flex md:justify-between md:items-center text-gray-800 dark:text-gray-200">
      <div class="flex items-center justify-between">
        <RouterLink to="/"
          class="text-xl flex items-center justify-center gap-1 font-bold text-gray-800 dark:text-gray-100 md:text-2xl hover:text-sky-400">
          <CarIcon/>
        </RouterLink>
        <!--Mobilemenu button-->
        <div @click="toggleNav" class="flex md:hidden">
          <button type="button" class="text-gray-900 dark:text-gray-100 hover:text-sky-400 focus:outline-none focus:text-gray-400">
            <MenuIcon />
          </button>
        </div>
      </div>
      <ul :class="showMenu ? 'flex' : 'hidden'"
        ...
        <li>
          <RouterLink class="dark:text-gray-100 text-gray-800 hover:text-sky-400" to="/">Home</RouterLink>
        </li>
        <li>
        ...
        <li>
          <RouterLink class="dark:text-gray-100 text-gray-800 hover:text-sky-400" to="/support">Support</RouterLink>
        </li>
